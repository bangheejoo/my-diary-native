...
exports.onNotificationCreated = (0, firestore_1.onDocumentCreated)('notifications/{notifId}', async (event) => {
    ...
    const ns = (_c = toProfile.data()) === null || _c === void 0 ? void 0 : _c.notifSettings;
    if ((ns === null || ns === void 0 ? void 0 : ns.all) === false)
        return;
    if ((type === 'friendRequest' || type === 'friendAccepted') && (ns === null || ns === void 0 ? void 0 : ns.friendRequest) === false)
        return;
    if ((type === 'comment' || type === 'reaction') && (ns === null || ns === void 0 ? void 0 : ns.commentReaction) === false)
        return;
    if (type === 'mention' && (ns === null || ns === void 0 ? void 0 : ns.mention) === false)
        return;
    const fromNickname = (_e = (_d = fromProfile.data()) === null || _d === void 0 ? void 0 : _d.nickname) !== null && _e !== void 0 ? _e : '알 수 없음';
    ...
    const response = await (0, node_fetch_1.default)('https://exp.host/--/api/v2/push/send', {
        ...
        body: JSON.stringify({
            ...
            title: '하루조각',
            body,
            data: { postId: postId !== null && postId !== void 0 ? postId : null, type, notifId: event.params.notifId },
            sound: 'default',
            badge: 1,
            channelId: 'default',
        }),
    ...
    if (((_f = result.data) === null || _f === void 0 ? void 0 : _f.status) === 'error') {
